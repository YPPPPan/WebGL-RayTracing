...
// Default settings: put camera eye-point at world-space origin, and
  ...
  this.lightPt = new Array();
  this.lightPt.push(vec4.fromValues(0,0,10,1));
  this.lightPt.push(vec4.fromValues(0,-8,2,1));
...
CCamera.prototype.setShadowRay = function(myShadowRay, hitPt, l){
  //console.log(this.lightPt[l]);
	vec4.copy(myShadowRay.orig, this.lightPt[l]);
  var t = vec4.create();
  vec4.subtract(t, hitPt, this.lightPt[l]);
	vec4.copy(myShadowRay.dir, t);
}

CCamera.prototype.setReflectRay = function(myReflectRay, hitPt, dir){
	vec4.copy(myReflectRay.orig, hitPt);	
	vec4.copy(myReflectRay.dir, dir);
}
...
CCamera.prototype.setLight = function(lp) {
  this.lightPt[0] = lp;
}
